...
export class PropostasComponent implements OnInit {
  ...
  private _propostasList$: BehaviorSubject<Array<IProjetoTableData>> =
    new BehaviorSubject<Array<IProjetoTableData>>([]);

  public get propostasList$(): Observable<Array<IProjetoTableData>> {
    return this._propostasList$;
  }
  ...
  private fetchPage(pageConfigParam?: {
    ...
    this._projetosService
      ...
      .pipe(
        tap((response) => {
          this._propostasList$.next(response.content);
