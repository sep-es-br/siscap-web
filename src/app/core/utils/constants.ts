...
const ERRO_MENSAGEM_PROGRAMA_ORGAO_SEM_PAPEL: string = 'Todos os órgãos devem possuir um papel selecionado.';
...
export const COLECAO_ERRO_MENSAGEM: Record<string, string> = {
  ...
  orgaoPrecisaTerUmPapel: ERRO_MENSAGEM_PROGRAMA_ORGAO_SEM_PAPEL,
};
...
export const COLECAO_TEXTO_TOOLTIP_FORMULARIO_PROJETO: Record<string, string> =
  {
    ...
    descricaoAcoesSecudariasProdutos: 'Inserir as ações secundárias, se houver, e os produtos. Os produtos deverão compreender os bens ou serviços oferecidos pelo DIC e estar associados à etapa ou subetapa, conforme o caso.',
    ...
    dicelegivel: 'Lista de DICs elegíveis para vinculação a um programa.'
  };
